...
HCP_DUM_125,		//125
HCP_DUM_126,		//126
HCP_NOTFOUND_ERR,	//127
HCP_NO_IMAGE_ERR,	//128	// 0x0080 VIP_COMM ERRCODE
HCP_WIFI_IOBOX_ERR,		//129
HCP_WIFI_NO_ASSOCIATION,	//130
HCP_WIFI_NO_WAKEUP,		//131
HCP_WIFI_RECEPTOR_ERR,		//132
HCP_WIFI_BATTERY_LOW,		//133
HCP_WIFI_LINK_QUALITY_LOW,	//134
HCP_UNSUPP_NETWORK_CONFIG,  //135

// mammo changes; diagInfo changes;
HCP_ERROR_TEMPERATURE_1_HIGH_DIGITALBOARD_COMPONENTS,	// 136
HCP_ERROR_TEMPERATURE_2_HIGH_DIGITALBOARD_GLASS,		// 137
HCP_ERROR_TEMPERATURE_3_HIGH_DIGITALBOARD_COMPONENTS,	// 138
HCP_ERROR_TEMPERATURE_4_HIGH_SNAPONBOARD_COMPONENTS,	// 139
HCP_ERROR_TEMPERATURE_5_HIGH_SNAPONBOARD_COMPONENTS,	// 140
HCP_ERROR_TEMPERATURE_6_HIGH_SNAPONBOARD_COMPONENTS,	// 141
HCP_ERROR_TEMPERATURE_7_HIGH,							// 142
HCP_ERROR_TEMPERATURE_8_HIGH,							// 143

HCP_ERROR_VOLTAGE_1_LOW,								// 144
HCP_ERROR_VOLTAGE_2_LOW,								// 145
HCP_ERROR_VOLTAGE_3_LOW,								// 146
HCP_ERROR_VOLTAGE_4_LOW,								// 147
HCP_ERROR_VOLTAGE_5_LOW,								// 148
HCP_ERROR_VOLTAGE_6_LOW,								// 149
HCP_ERROR_VOLTAGE_7_LOW,								// 150
HCP_ERROR_VOLTAGE_8_LOW,								// 151
HCP_ERROR_VOLTAGE_9_LOW,								// 152
HCP_ERROR_VOLTAGE_A_LOW,								// 153
HCP_ERROR_VOLTAGE_B_LOW,								// 154
HCP_ERROR_VOLTAGE_C_LOW,								// 155
HCP_ERROR_VOLTAGE_D_LOW,								// 156
HCP_ERROR_VOLTAGE_E_LOW,								// 157
HCP_ERROR_VOLTAGE_F_LOW,								// 158
HCP_ERROR_VOLTAGE_G_LOW,								// 159							

HCP_ERROR_VOLTAGE_1_HIGH,								// 160
HCP_ERROR_VOLTAGE_2_HIGH,								// 161
HCP_ERROR_VOLTAGE_3_HIGH,								// 162
HCP_ERROR_VOLTAGE_4_HIGH,								// 163
HCP_ERROR_VOLTAGE_5_HIGH,								// 164
HCP_ERROR_VOLTAGE_6_HIGH,								// 165
HCP_ERROR_VOLTAGE_7_HIGH,								// 166
HCP_ERROR_VOLTAGE_8_HIGH,								// 167
HCP_ERROR_VOLTAGE_9_HIGH,								// 168
HCP_ERROR_VOLTAGE_A_HIGH,								// 169
HCP_ERROR_VOLTAGE_B_HIGH,								// 170
HCP_ERROR_VOLTAGE_C_HIGH,								// 171
HCP_ERROR_VOLTAGE_D_HIGH,								// 172
HCP_ERROR_VOLTAGE_E_HIGH,								// 173
HCP_ERROR_VOLTAGE_F_HIGH,								// 174
HCP_ERROR_VOLTAGE_G_HIGH,								// 175

HCP_DEVICE_BUSY,										// 176
HCP_REC_CANCEL_FAILED,									// 177
HCP_DEFECT_FILE_UUID_MISMATCH,							// 178
...
static const char *HcpErrStrList[] = {
	...
	"Other Error",			//  6
	"Jumbo Packets not configured - min size 8000 bytes",		//  7
	"No Data Error",		//  8
	"Bad Ini File",			//  9
	"Bad Gain Ratio",		// 10
	...
	"Bad Pointer",			// 29
	"Timed out",			// 30
	"Fast Mode Switch Not Available for this FW",		// 31
	"Setup Error",			// 32
	"Drive Not Found",		// 33
	...
	"!!Unknown Error",				// 75
	"!!Unknown Error",				// 76
	"WARNING: Extended gain calibration completed, but " \
			"problem gain bits exceed 10%",	// 77
	"WARNING: Captured image has unexpected size", // 78
	...
	"Receptor temperature over threshold",						//114
	"Link speed error",				//115
	"vip_sw_handshaking() not supported for acquisition in DualRead mode",	//116
	"ACE error or unsupported",		//117
	"Pleora water mark reached",	//118
	"!!Unknown Error",				//119
	"!!Unknown Error",				//120
	"!!Unknown Error",				//121
	"!!Unknown Error",				//122
	...
	"Unable to Find",				//127
	"No Image",						//128
	"Cannot reach WiFi I/O box",			//129
	"Cannot associate to WiFi receptor",		//130
	"Cannot wakeup WiFi receptor",			//131
	"Cannot reach WiFi receptor",			//132
	"Battery level is too low",			//133
	"WiFi link quality is too low",			//134
	"Unsupported network configuration - make sure " \
			"the receptor, I/O box (if present), " \
			"and network card are on the same subnet", //135

	// mammo changes; diagInfo changes;
	"Digital Board (Components) temperature too high (Temperature 1)",	// 136
	"Digital Board (Glass) temperature too high      (Temperature 2)",	// 137
	"Digital Board (Components) temperature too high (Temperature 3)",	// 138
	"Digital Board (Components) temperature too high (Temperature 4)",	// 139
	"Snap on Board (Components) temperature too high (Temperature 5)",	// 140
	"Snap on Board (Components) temperature too high (Temperature 6)",	// 141
	"Unused temperature is too high",									// 142
	"Unused temperature is too high",									// 143

	"Voltage source 22V (Power Supply) is low",							// 144
	"Voltage source AVGL(Config File) is low",							// 145
	"Voltage source VEE	(Power Supply) is low",							// 146
	"Voltage source M4V (Power Supply) is low",							// 147
	"Voltage source VCC3(Power Supply) is low",							// 148
	"Voltage source VCC2.5 (Power Supply) is low",						// 149
	"Voltage source VCC1.2 (Power Supply) is low",						// 150
	"Voltage source AVGH (Config File) is low",							// 151
	"Voltage source p5.5d_v (Power Supply) is low",						// 152
	"Voltage source p5.5a_v (Power Supply) is low",						// 153
	"Voltage source VDD (Power Supply) is low",							// 154
	"Voltage source 28V (Power Supply) is low",							// 155
	"Voltage source unused low",										// 156
	"Voltage source unused low",										// 157
	"Voltage source unused low",										// 158
	"Voltage source unused low",										// 159

	"Voltage source 22V (Power Supply) is high",						// 160
	"Voltage source AVGL (Config File) is high",						// 161
	"Voltage source VEE (Power Supply) is high",						// 162
	"Voltage source M4V (Power Supply) is high",						// 163
	"Voltage source VCC3 (Power Supply) is high",						// 164
	"Voltage source VCC2.5 (Power Supply) is high",						// 165
	"Voltage source VCC1.2 (Power Supply) is high",						// 166
	"Voltage source AVGH is (Config File) high",						// 167
	"Voltage source p5.5d_v (Power Supply) is high",					// 168
	"Voltage source p5.5a_v (Power Supply) is high",					// 169
	"Voltage source VDD (Power Supply) is high",						// 170
	"Voltage source 28V (Power Supply) is high",						// 171
	"Voltage source unused high",										// 172
	"Voltage source unused high",										// 173
	"Voltage source unused high",										// 174
	"Voltage source unused high",										// 175
	"Device is busy",													// 176
	"Cancel Failed",													// 177
	"Defect file UUID mismatch",										// 178
...
// Mammo Constant
#define MAMMO_TOMO_MODE  0x08

// Acquisition Constants
#define VIP_ACQ_TYPE_CONTINUOUS   0  // FLUORO
#define VIP_ACQ_TYPE_ACCUMULATION 1	 // RAD
