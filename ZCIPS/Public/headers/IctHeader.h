...
enum{
	...
	CONEJOINT_SCAN,											//锥束拼接扫描
	CONEJOINT_ROT_SCAN,

	ASSEMBLEFORCONEJOINT_ROT_SCAN,							//发送给CTDISPOSE，启动拼接
	ASSEMBLEFORCONEJOINT_SCAN,
	LOADCORRECTEDGAINDATA,
	LOADCORRECTEDDARKDATA,
	LOADCORRECTEDNONLINERGAINDATA,
	CREATE_NONLINER_DATA,										//非线性空气校正
